    ...
    public class EmployeeRepository : IEmployeeRepository
    {
        ...
        public async Task CreateEmployeeAsync(EmployeeDomain employee)
        {
            try
            {
                ...
                employeeData.Restaurant = await _dbContext.Restaurants.FindAsync(employeeData.RestaurantId);
        ...
        public async Task UpdateEmployeeAsync(EmployeeDomain employee)
        {
            try
            {
                ...
                await DeleteEmployeeAsync(employeeData.EmployeeId);
        ...
        public async Task<double> CalculateAverageOrderAmountAsync(int employeeId)
        {
            try
            {
                ...
                if (ordersData.Any())
                {
                    var totalAmount = ordersData.Sum(o => o.TotalAmount);
