    ...
    public class CustomerRepository : ICustomerRepository
    {
        ...
        public async Task<List<CustomerDomain>> GetAllCustomersAsync()
        {
            try
            {
                ...
                var customersDomin = customers.Select(c => _mapper.Map<CustomerDomain>(customers)).ToList();

                return customersDomin;
            }
            catch (Exception ex)
            {
        ...
        public async Task<List<CustomerDomain>> FindCustomersWithLargePartiesAsync(int minPartySize)
        {
            try
            {
                ...
                var customersDomin = customers.Select(c => _mapper.Map<CustomerDomain>(c)).ToList();
