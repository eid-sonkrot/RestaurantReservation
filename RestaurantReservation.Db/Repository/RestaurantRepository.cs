    ...
    public class RestaurantRepository : IRestaurantRepository
    {
        ...
        public async Task UpdateRestaurantAsync(RestaurantDomain restaurant)
        {
            try
            {
                ...
                var existingRestaurantEntity = await _dbContext.Reservations.FindAsync(restaurantEntity.RestaurantId);
        ...
        public async Task<double> CalculateTotalRevenue(int restaurantId)
        {
            try
            {
                var totalRevenue = _dbContext.CalculateTotalRevenue(restaurantId);
